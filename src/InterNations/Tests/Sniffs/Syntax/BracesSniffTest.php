...
class BracesTest extends AbstractTestCase
{
    public function testInvalidDocBlocks(): void
    {
        ...
        $this->assertReportContains(
            ...
            '..InterNations\Sniffs\Syntax\Braces.MissingNewlineClassBrace',
            5
        );
        $this->assertReportContains(
            $errors,
            ...
            '..InterNations\Sniffs\Syntax\Braces.TooManyNewlinesClassBrace',
            5
        );
        $this->assertReportContains(
            $errors,
            ...
            '..InterNations\Sniffs\Syntax\Braces.MissingNewlineInterfaceBrace',
            5
        );
        $this->assertReportContains(
            $errors,
            ...
            '..InterNations\Sniffs\Syntax\Braces.TooManyNewlinesInterfaceBrace',
            5
        );
        $this->assertReportContains(
            $errors,
            ...
            '..InterNations\Sniffs\Syntax\Braces.MissingNewlineTraitBrace',
            5
        );
        $this->assertReportContains(
            $errors,
            ...
            '..InterNations\Sniffs\Syntax\Braces.TooManyNewlinesTraitBrace',
            5
        );
        $this->assertReportContains(
            $errors,
            ...
            '..InterNations\Sniffs\Syntax\Braces.MissingNewlineFunctionBrace',
            5
        );
        $this->assertReportContains(
            $errors,
            ...
            '..InterNations\Sniffs\Syntax\Braces.TooManyNewlinesFunctionBrace',
            5
        );
