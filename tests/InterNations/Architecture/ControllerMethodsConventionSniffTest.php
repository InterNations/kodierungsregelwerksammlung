...
class ControllerMethodsConventionSniffTest extends AbstractTestCase
{
    public function testWebControllerConventions(): void
    {
        ...
        static::assertReportContains(
            ...
            $file,
            'errors',
            'Public methods in web controllers are limited to "deleteAction()", "editAction()", "getAction()", "headAction()", "indexAction()", "newAction()", "optionsAction()", "patchAction()", "postAction()", "putAction()" but "invalidAction()" found. This is often a hint that you are dealing with a sub resource of the current resource that justifies its own controller and should be extracted into its own controller.'
        );
    }
    ...
    public function testApiControllerConventions(): void
    {
        ...
        static::assertReportContains(
            ...
            $file,
            'errors',
            'Public methods in API controllers are limited to "deleteAction()", "getAction()", "headAction()", "indexAction()", "optionsAction()", "patchAction()", "postAction()", "putAction()" but "newAction()" found. This is often a hint that you are dealing with a sub resource of the current resource that justifies its own controller and should be extracted into its own controller.'
        );
        static::assertReportContains(
            $errors,
            $file,
            'errors',
            'Public methods in API controllers are limited to "deleteAction()", "getAction()", "headAction()", "indexAction()", "optionsAction()", "patchAction()", "postAction()", "putAction()" but "editAction()" found. This is often a hint that you are dealing with a sub resource of the current resource that justifies its own controller and should be extracted into its own controller.'
        );
        static::assertReportContains(
            $errors,
            $file,
            'errors',
            'Public methods in API controllers are limited to "deleteAction()", "getAction()", "headAction()", "indexAction()", "optionsAction()", "patchAction()", "postAction()", "putAction()" but "invalidAction()" found. This is often a hint that you are dealing with a sub resource of the current resource that justifies its own controller and should be extracted into its own controller.'
        );
    }
}
